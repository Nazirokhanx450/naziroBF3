...
# LO KONTOL
logo =  ''' \033[0;96m  888888  dP"Yb   dP"Yb  88""Yb 
\033[0;96m    88   dP   Yb dP   Yb 88__dP \033[0;97m|| Created By NaZir-XD
\033[0;96m   88   Yb   dP Yb   dP 88"Yb   \033[0;97m|| Youtube NaZir-XD
\033[0;96m  88    YbodP   YbodP  88  Yb\033[0;91mv2.9\033[0;97m|| Facebook NaZir KHaN'''
...
def moch_yayan():
    ...
    print '___________________________________________________________\n';time.sleep(0.03)
    print '%s╔═[%s Author  : \033[0;97mNaZir  KHaN-XD'%(O,N);time.sleep(0.03)
    print '%s╠═[%s Github  : \033[0;97mGithub.com/NAZIROKHANX56'%(O,N);time.sleep(0.03)
